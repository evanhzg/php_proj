...
?>
  ...
  <div class="container-fluid p-0">
    ...
    <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="about">
      <div class="w-100">
        <h1 class="mb-0">Evan
          <span class="text-primary">Hoizey</span>
        </h1>
        <div class="subheading mb-5">77 route de Sartrouville · 78230 Le Pecq ·
          <a href="mailto:name@email.com">evan.hoizey@ynov.com</a>
        </div>
    ...
    <section class="resume-section p-3 p-lg-5 d-flex justify-content-center" id="experience">
      <div class="w-100">
        <h2 class="mb-5">Expérience <a href="admin/login.php#experience"><strong>MODIFIER</strong></a></h2>

        <?php
        $bdd = new PDO('mysql:host=localhost;dbname=experience;charset=utf8', 'root', '');
        $choix = $bdd->query('SELECT * FROM experience');
        while ($data = $choix->fetch()){
        ?>

        <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
          <div class="resume-content">
            <h3 class="mb-0"><?php echo $data['title']; ?></a></h3>
